...
*/
function tellFortune(number_of_children,name, geographic_location, job_title){
  console.log(`You will be a ${job_title} in ${geographic_location}, and married to ${name} with ${number_of_children} kids`)
}
...
*/
function calculateSupply( age, amount_perday){
  let result=(100-age)*365* amount_perday
...
function canIGetADrivingLicense(age){
  ...
  console.log(canIGetADrivingLicense(16));
